...
<html lang="en">
<head>
    <title>Code coverage report for src/compile/blocks.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/compile/blocks.js</span></h1>
    <h2>
        
        Statements: <span class="metric">96.55% <small>(112 / 116)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">97.32% <small>(109 / 112)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/compile/</a> &#187; blocks.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >          ret = this._render(block);</span>
      }
&nbsp;
      return ret || '';
    },
...
&nbsp;
        ...
        var jsArgs = [];
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (macro &amp;&amp; macro.apply) {
&nbsp;
...
&nbsp;
        utils.forEach(args, function(ref, i){
          <span class="missing-if-branch" title="else path not taken" >E</span>if (_call_args[i]) {
            local[ref.id] = this.getLiteral(_call_args[i]);
          } else {
<span class="cstat-no" title="statement not covered" >            local[ref.id] = undefined;</span>
          }
        }, this);
&nbsp;
...
&nbsp;
      if (!local) {
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (utils.isArray(str)) {
<span class="cstat-no" title="statement not covered" >          return this._render(str);</span>
        } else {
...
&nbsp;
          asts = str;
&nbsp;
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (Parser) {
&nbsp;
          asts = Parser.parse(str);
&nbsp;
        }
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (asts.length) {
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!_from || (type !== '[object Array]' &amp;&amp; type !== '[object Object]')) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Dec 21 2014 10:43:41 GMT+0800 (CST)</div>
</div>
