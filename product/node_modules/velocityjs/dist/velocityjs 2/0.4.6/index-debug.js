define("velocityjs/0.4.6/index-debug", [], function(require, exports, module) {
  'use strict';
  var Parser = require("velocityjs/0.4.6/src/parse/index-debug");
  var utils = require("velocityjs/0.4.6/src/utils-debug");
  var Compile = require("velocityjs/0.4.6/src/compile/index-debug");
  var Helper = {};
...
define("velocityjs/0.4.6/src/parse/index-debug", [], function(require, exports, module) {
...
define("velocityjs/0.4.6/src/utils-debug", [], function(require, exports, module) {
  "use strict";
  var utils = {
    noop: function noop() {
      var arg = arguments;
...
define("velocityjs/0.4.6/src/compile/index-debug", [], function(require, exports, module) {
  var utils = require("velocityjs/0.4.6/src/utils-debug");
  var Helper = require("velocityjs/0.4.6/src/helper/index-debug");
  ...
  require("velocityjs/0.4.6/src/compile/blocks-debug")(Velocity, utils);
  require("velocityjs/0.4.6/src/compile/literal-debug")(Velocity, utils);
  require("velocityjs/0.4.6/src/compile/references-debug")(Velocity, utils);
  require("velocityjs/0.4.6/src/compile/set-debug")(Velocity, utils);
  require("velocityjs/0.4.6/src/compile/expression-debug")(Velocity, utils);
  require("velocityjs/0.4.6/src/compile/compile-debug")(Velocity, utils);
  module.exports = Velocity;
});
define("velocityjs/0.4.6/src/helper/index-debug", [], function(require, exports, module) {
  var Helper = {};
  var utils = require("velocityjs/0.4.6/src/utils-debug");
  require("velocityjs/0.4.6/src/helper/text-debug")(Helper, utils);
  module.exports = Helper;
});
define("velocityjs/0.4.6/src/helper/text-debug", [], function(require, exports, module) {
...
define("velocityjs/0.4.6/src/compile/blocks-debug", [], function(require, exports, module) {
...
define("velocityjs/0.4.6/src/compile/literal-debug", [], function(require, exports, module) {
  module.exports = function(Velocity, utils) {
    /**
     * literal解释模块
...
define("velocityjs/0.4.6/src/compile/references-debug", [], function(require, exports, module) {
  module.exports = function(Velocity, utils) {
    'use strict'
...
define("velocityjs/0.4.6/src/compile/set-debug", [], function(require, exports, module) {
  module.exports = function(Velocity, utils) {
    /**
     * 变量设置
     */
...
define("velocityjs/0.4.6/src/compile/expression-debug", [], function(require, exports, module) {
  module.exports = function(Velocity, utils) {
    /**
     * expression运算
     */
...
define("velocityjs/0.4.6/src/compile/compile-debug", [], function(require, exports, module) {
  module.exports = function(Velocity, utils) {
    /**
     * compile
     */
