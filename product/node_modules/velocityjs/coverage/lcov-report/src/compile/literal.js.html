...
<html lang="en">
<head>
    <title>Code coverage report for src/compile/literal.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/compile/literal.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/compile/</a> &#187; literal.js</div>
</div>
<div class="body">
...
&nbsp;
        if (literal.value === "null") {
          ...
          ret = false;
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (literal.value === 'true') {
          ret = true;
        }
&nbsp;
      } else {
